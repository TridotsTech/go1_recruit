...
function getHTMLMediaElement(mediaElement, config) {
    ...
    if (buttons.has('take-snapshot')) {
        ...
        takeSnapshot.title = 'Take Snapshot';
    ...
    if (buttons.has('record-video')) {
        ...
        recordVideo.title = 'Record Video';
    ...
    if (buttons.has('full-screen')) {
        ...
        zoom.onclick = function() {
            if (zoom.className.indexOf('zoom-out') != -1) {
                ...
                zooming_element = mediaElementContainer;
                // mediaElementContainer.appendChild(zooming_element);
        ...
        function exitFullScreen() {
            ...
            mediaElementContainer = zooming_element;

            if (document.fullscreen) {
                try{document.cancelFullScreen();} catch(e){document.exitFullscreen();}
            }
